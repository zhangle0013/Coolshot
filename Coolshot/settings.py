...
# Creat on '15/11/6'
"""
Django settings for Coolshot project.
...
SECRET_KEY = '&e88m(teyn3gu3jrel6q_vu8p2(za@85!j72bb^)!4(m!z4bm0'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,  'templates'), ],  # 把路径加到这里检查语法的时候才不会报错
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Coolshot.wsgi.application'
